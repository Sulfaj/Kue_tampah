...
// Navigasi footer—update label dan tujuan jika menambah halaman baru.
...
// Sorotan layanan—ganti daftar ini sesuai fokus utama bisnismu.
const services = [
...
export const Footer = () => (
  // Footer global: atur copy, hashtag, dan informasi kontak di sini.
