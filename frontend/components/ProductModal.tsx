...
// Variasi animasi overlay—atur opacity/delay untuk rasa transisi berbeda.
const overlayVariants = {
  hidden: { opacity: 0 },
  visible: { opacity: 1 },
};

// Variasi animasi konten modal—ubah stiffness/damping untuk responsif yang berbeda.
const modalVariants = {
  ...
  <AnimatePresence>
    {open ? (
      ...
      >
        ...
        >
          {/* Kolom kiri menampilkan foto produk—ganti ukuran/aspect ratio sesuai kebutuhan. */}
          ...
          {/* Kolom detail—atur copywriting, catatan rasa, dan CTA di sini. */}
