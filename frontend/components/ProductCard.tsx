...
// Animasi kartu produk—ubah durasi/delay untuk rasa interaksi berbeda.
const cardVariants = {
...
export const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <>
      ...
      >
        {/* Area gambar utama—atur height atau behavior hover swap sesuai kebutuhan. */}
        <div className="relative h-60 w-full overflow-hidden rounded-[var(--radius-md)] bg-[var(--brand-cream-100)]">
          ...
          {/* Tombol buka modal detail—ubah teks atau aksi jika ingin tautan berbeda. */}
          <button
            type="button"
        ...
        <div className="flex flex-1 flex-col gap-4 pt-5">
          ...
          {/* CTA utama—ubah teks/warna untuk menyesuaikan strategi penjualan. */}
          <button
            type="button"
