...
// Komponen item keranjang versi reusable—pakai ketika ingin menampilkan list sederhana.
export const CartItem = ({ id, name, image, price, quantity }: CartItemProps) => {
  ...
  return (
    // Struktur kartu item—edit Tailwind class untuk menyesuaikan tampilan.
