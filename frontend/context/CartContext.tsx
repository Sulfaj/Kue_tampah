...
// Atur batasan jumlah produk per item—sesuaikan jika paketmu butuh angka lebih besar.
...
export const useCartStore = create<CartStore>()(
  persist(
    ...
    {
      // Ubah name storage bila ingin memisahkan keranjang antar brand/lingkungan.
...
// Gabungkan item keranjang dengan detail produk—ubah bila struktur Product berubah.
...
// Jadwalkan pengingat keranjang—ubah logika atau delay di utils/notify.ts.
